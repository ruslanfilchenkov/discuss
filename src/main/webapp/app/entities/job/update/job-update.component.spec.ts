...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 2779 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 1424 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 6405 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 25298 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 8586 };
      job.tasks = [task];
      const employee: IEmployee = { id: 8122 };
      job.employee = employee;
