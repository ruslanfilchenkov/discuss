...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 25047 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 6028 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 5033 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 30298 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 29521 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 13802 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 5173 };
      jobHistory.job = job;
      const department: IDepartment = { id: 29529 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 986 };
      jobHistory.employee = employee;
